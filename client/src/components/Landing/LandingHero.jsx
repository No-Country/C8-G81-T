      ...
      <div className="hero min-h-[600px] max-h-11" style={{ backgroundImage: `url('./images/herobg.avif')` }}>
        ...
        <div className="hero-content text-center text-neutral-content relative">
          <div className="max-w-md">
            <p className="mb-5 text-3xl text-white">En <span className="text-sky-normal">Medicalendar</span> nupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a id nisi.</p>
